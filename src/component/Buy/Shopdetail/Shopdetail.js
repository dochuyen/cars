    ...
    <div className={cx("wrapper")}>
      ...
      <Container>
        ...
        <div className={cx("detail-introduce")}>
          <Col lg={12}>
          <div className={cx('introduce-title')}>
          Explore the GTR
          </div>
          <img
            src="https://tse1.mm.bing.net/th?id=OIP.5CmhYL1kfc68xJo5gt8eawHaEK&pid=Api&P=0"
            alt=""
          />
          <p className={cx("introduce-text")}>The stitched leather overlays on the upper add heritage style, durability and support.</p>
          </Col>
        ...
        <div className={cx("product-involve")}>
          <div className={cx("involve-title")}>
            ...
            <div className={cx("icon-detail")}>
              <button className={cx('icon-next')}><AiOutlineLeft /></button>
              <button className={cx('icon-next')}><AiOutlineRight /></button>
            </div>
          </div>
